...
///////////////////////////////////////////////////////////////////////////
::xrn::engine::Camera::~Camera() = default;
...
///////////////////////////////////////////////////////////////////////////
auto ::xrn::engine::Camera::operator=(
    ::xrn::engine::Camera&&
) noexcept
    -> ::xrn::engine::Camera& = default;
...
///////////////////////////////////////////////////////////////////////////
void ::xrn::engine::Camera::setOrthographicProjection(
    const float left
    , const float right
    , const float top
    , const float bottom
...
///////////////////////////////////////////////////////////////////////////
void ::xrn::engine::Camera::setPerspectiveProjection(
    const float fovY
    , const float aspect
    , const float near
    , const float far
...
///////////////////////////////////////////////////////////////////////////
auto ::xrn::engine::Camera::getProjection() const
    -> const ::glm::mat4&
{
...
///////////////////////////////////////////////////////////////////////////
auto ::xrn::engine::Camera::getView() const
    -> const ::glm::mat4&
{
    return m_viewMatrix;
}
